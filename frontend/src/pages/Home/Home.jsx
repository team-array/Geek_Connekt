        ...
        <HomePage>
            ...
            <Main>
                <MainContext data-aos="fade-right">
                    <h1 style={{color:"#",fontWeight:"bold",wordSpacing:"0.3rem",wordWrap:"break-word",fontSize:"2rem"}}>Welcome to <span style={{color:"#0630ba",wordSpacing:"0rem"}}>{AppName}</span></h1>
                    <p style={{fontSize:"1.3rem",fontWeight:"600",color:"#444",fontStyle:"normal"}}>a social media platform for cmr college of engineering and technology.This is a web application that acts as a private social network for students, alumni, faculty and management of an institution</p>
                    ...
                    >Get Started &nbsp; <ArrowForwardIosIcon style={{fontSize:"1rem"}}/></Button>
                </MainContext>
